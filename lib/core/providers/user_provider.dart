...
class UserProfileNotifier extends StateNotifier<UserProfile?> {
      ...
      try {
        await FirebaseService.saveUserData(
          ...
          goals: {
            ...
            'weeklyWeightGoalKg': state!.weeklyWeightGoalKg,
          },
  ...
  UserProfile _profileFromFirestore(Map<String, dynamic> data) {
    ...
    return UserProfile(
      ...
      startingWeightKg: (goals['startingWeightKg'] as num?)?.toDouble(),
      weeklyWeightGoalKg: (goals['weeklyWeightGoalKg'] as num?)?.toDouble(),
      ...
      try {
        await FirebaseService.saveUserData(
          ...
          goals: {
            ...
            'weeklyWeightGoalKg': profile.weeklyWeightGoalKg,
          },
